...
/* Only GMAC0 is supported as the DSA conduit; setup rejects port 10. */
...
/*
 * VLAN table entry: member [10:0], untag [21:11], IVL/SVL [25] (1 = IVL).
 * FID/MSTI [23:22], SVLAN check [24] and extended mask index [30:26] are
 * left at 0.
 */
#define VLAN_MBR_MASK		0x7ff
#define VLAN_UNTAG_SHIFT	11
#define VLAN_IVL_SVL		BIT(25)
...
#define SWCORE_VLAN_EGR_MODE_KEEP	1	/* keep the ingress tag format */
